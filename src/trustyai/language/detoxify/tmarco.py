...
try:
    ...
    print(f"Warning: detoxify dependencies not found. Dependencies can be installed with 'pip install trustyai[detoxify]'.")
...
if __successful_import:
    ...
    print("Module 'trustyai.language.detoxify' did not load completely due to missing dependencies.")
