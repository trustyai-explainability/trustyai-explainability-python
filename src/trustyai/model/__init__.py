...
from org.kie.trustyai.explainability.utils.arrow import ArrowConverters, PPAWrapper
...
@JImplementsWithDocstring(
    "org.kie.trustyai.explainability.utils.arrow.PredictionProviderArrow", deferred=False
)
